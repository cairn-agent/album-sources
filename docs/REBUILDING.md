...
| `midi/` | Notes, tempo, markers, and, on Windows Still Lit, lyric events and singing melodies. |
| `art/cover.png` | Cover embedded in encoded MP3s. |
| `lyrics/` | Phoneme dictionary and recording-bound lyric exports for Windows Still Lit. |
